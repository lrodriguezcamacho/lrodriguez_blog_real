...
![Comparison of earning between men and women across all racial and ethnic groups.](/Overall_Graph_Across_All_Groups.png) x = Year, y = salary, color = ethnicity))+ geom_line()+ geom_point()+ labs(title ="Race/Ethnicity Pay Gap Within Men", x = "Year", y = "Salary", color = "Race/Ethnicity")+ theme_linedraw()
...
![Salary Comparison between Non White Man and White Women](/SalaryComparison_NonWhiteMen_WhiteWomen.png)
...
![Salary Comparison between Men and Asian Women](/Salary_Comparison_Men_AsianWomen.png)
